# Jira API-token picker snapshot: 2026-06-09

Cached reflection of Jira scopes visible in the Atlassian API-token picker on
2026-06-09. This is reference material only; use
[../token-scopes.md](../token-scopes.md#jira) for the curated starter set.

Descriptions are intentionally omitted here. This file preserves the observed
scope names so the recommendation can stay focused on the safe 50-scope recipe.

## Delete/import/admin scopes
...
- `delete:itam-config:jira-service-management`
...
- `delete:servicedesk.property:jira`
...
- `import:cmdb-import-configuration:jira`
...
- `read:itam-config:jira-service-management`
- `read:itam-inventory:jira-service-management`
...
- `read:servicedesk.property:jira`
...
- `send:workday-events:jira-service-management`
- `validate:jql:jira`
...
- `write:itam-config:jira-service-management`
- `write:jira-work`
...
- `write:servicedesk.property:jira`
